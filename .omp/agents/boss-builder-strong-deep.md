---
name: boss-builder-strong-deep
description: Implements one hardest bounded coding task using the strong worker role with high reasoning effort. Never delegates.
