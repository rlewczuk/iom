---
name: boss-builder-fast-deep
description: Implements one bounded but fiddly coding task on the cheap worker role with high reasoning effort. Never delegates.
