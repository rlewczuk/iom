...
| Implementation owner | `spec-run-all-implementer` / `@implementer` | Assigned-worktree implementation, focused build/unit/conformance testing before ready handoff, and its one-time `spec-run-debug` rescue. |
