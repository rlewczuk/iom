...
| Implementation owner | `spec-run-all-implementer` / `@implementer` | Assigned-worktree implementation, focused build/unit/conformance testing before ready handoff, and mandatory one-time `csw-debug` rescue when progress stalls. |
