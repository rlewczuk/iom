...
- `REMOTE_DEV_CONFIG=/tmp/task-53-cc003.remote-hosts.conf .agents/skills/remote-development/scripts/remote-exec sycl task-53-cc003 'flock /tmp/agent-gpu0.lock -c "ctest --test-dir build/sycl-cc003 --output-on-failure -R iom_backend_coexistence_tests"'` — 1/1 test passed in 0.87 seconds; all CPU+SYCL coexistence assertions passed.
