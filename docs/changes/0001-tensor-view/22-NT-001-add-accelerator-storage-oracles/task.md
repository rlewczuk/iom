...
- `remote-exec cuda task-nt001-cuda` — CUDA negative fixture and full storage-oracle sweep passed; full sweep reported 17,253 assertions passed.
- `remote-exec rocm task-nt001-rocm` — ROCm negative fixture and full storage-oracle sweep passed; full sweep reported 17,091 assertions passed.
- `remote-exec ttnn task-nt001-ttnn` — TTNN negative fixture and full storage-oracle sweep passed; full sweep reported 34,948 assertions passed.
