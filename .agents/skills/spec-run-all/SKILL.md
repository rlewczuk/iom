...
python3 .agents/skills/spec-run-all/scripts/spec_run_all.py --repo <repo> --pretty control
python3 .agents/skills/spec-run-all/scripts/check_omp_config.py --repo <repo> --pretty
```
